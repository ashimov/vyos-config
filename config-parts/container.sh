...
set container name adguardhome image 'docker.io/adguard/adguardhome:v0.107.51'
...
# omada-controller
set container name omada-controller image 'docker.io/mbentley/omada-controller:5.13'
